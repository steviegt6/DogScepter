...
namespace GameBreaker.Project.Assets
{
    public class AssetObject : Asset
    {
        ...
        public record struct PhysicsProperties
        {
            ...
            public Models.GMObject.PhysicsProperties.CollisionShape Shape { get; set; }
            ...
            public static explicit operator PhysicsProperties(Models.GMObject.PhysicsProperties physicsProperties)
            {
                ...
                foreach (Models.GMObject.PhysicsVertex v in physicsProperties.Vertices)
