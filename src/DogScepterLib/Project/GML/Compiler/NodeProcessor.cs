            ...
            case NodeKind.ChainReference:
                     ...
                     n.Children[1].Kind == NodeKind.FunctionCall))
                {
                    ...
                    if (c.Kind == ConstantKind.Number)
                    {
                        ...
                        {
                            case -1:
                                type = (int)GMCode.Bytecode.Instruction.InstanceType.Self;
                                break;
                            case -2:
                                type = (int)GMCode.Bytecode.Instruction.InstanceType.Other;
                                break;
                            case -5:
                                type = (int)GMCode.Bytecode.Instruction.InstanceType.Global;
                                break;
                            default:
                    ...
                    if (type != null)
                    {
                        ...
                        else
                        {
                            ...
                            tokenFunc.ExplicitInstType = (GMCode.Bytecode.Instruction.InstanceType)type;
                        }
