...
using static GameBreaker.Project.GML.Decompiler.MacroResolverTypes;
...
public static class MacroResolver
{
    ...
    public static ASTNode ResolveAny(DecompileContext ctx, ASTNode node, MacroResolverTypes.ConditionalMacroType type)
    {
    ...
    public static ASTNode ResolveInt(DecompileContext ctx, ASTNode intNode, MacroResolverTypes.ConditionalMacroType type)
    {
    ...
    {
        MacroResolverTypes.ConditionalMacroType left = GetExpressionType(ctx, assign.Children[0]);
    ...
    {
        MacroResolverTypes.ConditionalMacroType left = GetExpressionType(ctx, bin.Children[0]);
        MacroResolverTypes.ConditionalMacroType right = GetExpressionType(ctx, bin.Children[1]);
    ...
    {
        MacroResolverTypes.ConditionalMacroType expr = GetExpressionType(ctx, sw.Children[0]);
    ...
    public static MacroResolverTypes.ConditionalMacroType GetExpressionType(DecompileContext ctx, ASTNode node)
    {
        switch (node.Kind)
        {
